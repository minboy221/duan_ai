    ...
    <div class="p-8 md:p-16 flex flex-col justify-center bg-surface-bright">
        ...
        <form class="space-y-6" method="POST" action="{{ route('login.post') }}">
            ...
            <div>
                ...
                <input class="w-full px-4 py-3 rounded-xl border-none bg-surface-container-low text-on-surface focus:ring-2 focus:ring-primary-container transition-all placeholder:text-outline-variant @error('email') border border-error bg-error-container/10 @enderror" id="email" name="email" placeholder="curator@finance.vn" type="email" autofocus value="{{ old('email') }}"/>
                @error('email')
            ...
            <div>
                ...
                <div class="relative">
                    <input class="w-full px-4 py-3 rounded-xl border-none bg-surface-container-low text-on-surface focus:ring-2 focus:ring-primary-container transition-all placeholder:text-outline-variant @error('password') border border-error bg-error-container/10 @enderror" id="password" name="password" placeholder="••••••••" type="password"/>
